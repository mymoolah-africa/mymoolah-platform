...
export const PartnerOnboardingOverlay: React.FC = () => {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-[var(--foreground)]">Partner Onboarding</h1>
        <p className="text-sm text-[var(--muted-foreground)] mt-1">
          Manage supplier and merchant partner integrations and onboarding workflows.
        </p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-[var(--border)] p-12 flex flex-col items-center text-center">
        ...
        <p className="text-sm text-[var(--muted-foreground)] max-w-md mb-8">
          Partner lifecycle management—from intake through integration health and SLAs—will be
          supported here in an upcoming release.
        </p>
