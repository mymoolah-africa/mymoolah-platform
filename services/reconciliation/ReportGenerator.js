...
const logger = {
  info: (...args) => console.log('[ReportGenerator]', ...args),
  error: (...args) => console.error('[ReportGenerator]', ...args),
  warn: (...args) => console.warn('[ReportGenerator]', ...args),
  debug: (...args) => console.log('[ReportGenerator]', ...args)
};
