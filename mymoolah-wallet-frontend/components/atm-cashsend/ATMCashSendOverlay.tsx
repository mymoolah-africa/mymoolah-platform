...
export function ATMCashSendOverlay() {
  return (
    <div role="dialog" aria-labelledby="atm-cashsend-title" aria-describedby="atm-cashsend-desc" style={{ padding: '1rem' }}>
      ...
      <p style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '14px', color: '#6b7280' }}>Overlay placeholder. Final production design should be built directly in code using the MyMoolah design system.</p>
    </div>
  );
}
