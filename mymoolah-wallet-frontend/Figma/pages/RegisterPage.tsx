...
export function RegisterPage() {
  ...
  const identifierValidation = validateIdentifier(formData.identifier, inputType);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!identifierValidation.isValid || !passwordValidation.isValid || !passwordsMatch || !formData.name || !formData.email) {
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className={`bg-white border-gray-200 focus:border-[#86BE41] focus:ring-[#86BE41] pl-12 ${
                        !identifierValidation.isValid && formData.identifier.trim() ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 
                        identifierValidation.isValid && formData.identifier.trim() ? 'border-green-300 focus:border-green-500 focus:ring-green-500' : ''
                      }`}
                      style={{ 
                        height: 'var(--mobile-touch-target)',
                        fontFamily: 'Montserrat, sans-serif',
                ...
                <div className="space-y-2">
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-2 mb-2">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex-1">
                          <p className="text-blue-700 text-xs mb-1" style={{ 
                            fontFamily: 'Montserrat, sans-serif', 
                            fontSize: '11px',
                            fontWeight: 'var(--font-weight-bold)'
                          }}>
                          ...
                          <p className="text-blue-600 text-xs" style={{ 
                            fontFamily: 'Montserrat, sans-serif', 
                            fontSize: '10px',
                            fontWeight: 'var(--font-weight-normal)'
                          }}>
                  ...
                  {showPasswordValidation && formData.password.length > 0 && (
                    <div className="mt-2 p-3 bg-gray-50 rounded-lg border" style={{ 
                      borderRadius: 'var(--mobile-border-radius)'
                    }}>
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div className={`flex items-center gap-1 text-xs ${passwordValidation.minLength ? 'text-green-600' : 'text-red-600'}`}>
                          {passwordValidation.minLength ? <Check className="w-3 h-3" /> : <X className="w-3 h-3" />}
                          <span style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '11px' }}>8+ chars</span>
                        </div>
                        <div className={`flex items-center gap-1 text-xs ${passwordValidation.hasUppercase ? 'text-green-600' : 'text-red-600'}`}>
                          {passwordValidation.hasUppercase ? <Check className="w-3 h-3" /> : <X className="w-3 h-3" />}
                          <span style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '11px' }}>A-Z</span>
                        </div>
                        <div className={`flex items-center gap-1 text-xs ${passwordValidation.hasLowercase ? 'text-green-600' : 'text-red-600'}`}>
                          {passwordValidation.hasLowercase ? <Check className="w-3 h-3" /> : <X className="w-3 h-3" />}
                          <span style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '11px' }}>a-z</span>
                        </div>
                        <div className={`flex items-center gap-1 text-xs ${passwordValidation.hasNumber ? 'text-green-600' : 'text-red-600'}`}>
                          {passwordValidation.hasNumber ? <Check className="w-3 h-3" /> : <X className="w-3 h-3" />}
                          <span style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '11px' }}>0-9</span>
                        </div>
                        <div className={`flex items-center gap-1 text-xs col-span-2 ${passwordValidation.hasSpecialChar ? 'text-green-600' : 'text-red-600'}`}>
                          {passwordValidation.hasSpecialChar ? <Check className="w-3 h-3" /> : <X className="w-3 h-3" />}
                          <span style={{ fontFamily: 'Montserrat, sans-serif', fontSize: '11px' }}>Special (!@#$)</span>
                        </div>
                      </div>
                    </div>
                  )}
                ...
                <div className="space-y-2">
                  ...
                  {formData.confirmPassword && (
                    <div style={{ 
                      ...
                      <span className={`inline-flex items-center gap-1 ${passwordsMatch ? 'text-green-600' : 'text-red-600'}`}>
                ...
                <Button
                  type="submit"
                  disabled={!identifierValidation.isValid || !passwordValidation.isValid || !passwordsMatch || !formData.name || !formData.email || isLoading}
              ...
              <Dialog>
                ...
                <DialogContent className="mobile-container">
                  ...
                  <div style={{ 
                    ...
                    <p>By creating a MyMoolah wallet, you agree to our terms and conditions for secure digital wallet services and KYC compliance.</p>
                  </div>
                </DialogContent>
              </Dialog>
              ...
              <Dialog>
                ...
                <DialogContent className="mobile-container">
                  ...
                  <div style={{ 
                    ...
                    <p>MyMoolah uses enterprise-grade encryption and comprehensive KYC verification to protect your financial data with the same security standards as major banks.</p>
                  </div>
                </DialogContent>
              </Dialog>
              ...
              <Dialog>
                ...
                <DialogContent className="mobile-container">
                  ...
                  <div style={{ 
                    ...
                    <p><strong>Q: What documents do I need for verification?</strong></p>
                    <p>A: South African ID or Passport, plus proof of address (utility bill, bank statement).</p>
                    <br />
                    <p><strong>Q: How long does account verification take?</strong></p>
                    <p>A: Usually 2-5 minutes with our automated KYC system.</p>
                  </div>
                </DialogContent>
              </Dialog>
            </div>
