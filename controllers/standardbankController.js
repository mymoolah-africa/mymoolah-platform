...
function getBankCodeFromName(bankName) {
  const bankCodes = {
    ...
    'Bidvest Bank': '462005', 'Bidvest Bank Limited': '462005', 'Bidvest Bank Alliances': '683000',
    'Capitec Bank': '470010', 'Capitec Bank Limited': '470010', 'Capitec Business': '450105',
    ...
    'Sasfin Bank': '683000', 'Sasfin Bank Limited': '683000',
...
function getProxyDomainFromName(bankName) {
  const proxyDomains = {
    'Standard Bank': 'standardbank', 'Standard Bank of SA': 'standardbank',
    'Capitec Bank': 'capitec', 'Capitec Bank Limited': 'capitec',
    'ABSA Bank': 'absa', 'Absa Bank Limited': 'absa',
    'First National Bank (FNB)': 'fnb', 'First National Bank': 'fnb', 'FNB': 'fnb',
    'RMB': 'rmb',
    'Nedbank': 'nedbank', 'Nedbank Limited': 'nedbank',
    'African Bank': 'africanbank', 'African Bank Limited': 'africanbank',
    'TymeBank': 'tymebank', 'Tyme Bank Limited': 'tymebank',
    'Discovery Bank': 'discoverybank', 'Discovery Bank Limited': 'discoverybank',
    'Investec Bank': 'investec', 'Investec Bank Limited': 'investec',
    'HBZ Bank': 'hbz', 'HBZ Bank Limited': 'hbz',
    'OM Bank': 'ombank', 'OM Bank Limited': 'ombank',
    'Al Baraka Bank': 'albaraka',
    'Sasfin Bank': 'sasfin', 'Sasfin Bank Limited': 'sasfin',
    'Bidvest Bank': 'hellopaisa', 'Bidvest Bank Limited': 'hellopaisa', 'Bidvest Bank Alliances': 'hellopaisa',
    'eNL Mutual Bank': 'enl',
  };
