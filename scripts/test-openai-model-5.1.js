...
/**
 * Test Script: Check if OpenAI GPT-5.1 model is available
 * 
 * This script tests if the GPT-5.1 model is available in your OpenAI account
 * and can be used for API calls.
 * 
 * Usage:
 *   node scripts/test-openai-model-5.1.js
 * 
 * Requirements:
