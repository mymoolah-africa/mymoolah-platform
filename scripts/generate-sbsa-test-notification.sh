#!/usr/bin/env bash
# Generate a clean SBSA SOAP test notification XML file (SDD V1.3 compliant)
...
<NS1:Envelope xmlns:NS1="http://schemas.xmlsoap.org/soap/envelope/">
  <NS1:Body>
    <NS2:SendTransactionNotificationAsync xmlns:NS2="http://standardbank.co.za/sa/services/Enterprise/Business/PaymentsandTransafers/PaymentNotificationV1/Base">
      <NS3:RqUID xmlns:NS3="http://standardbank.co.za/sa/services/Global/IfxV2_1/HeaderV2_0">a1b2c3d4-e5f6-7890-abcd-ef1234567890</NS3:RqUID>
      ...
      <NS2:SendTransactionNotificationAsync>
        <NS2:TrnNotificationInfo>
          ...
          <NS2:TrnData>
            ...
            <NS2:TrnDt>2026-03-26</NS2:TrnDt>
            <NS2:TrnTime>12:00:00</NS2:TrnTime>
            <NS2:TrnAmt>
              <NS2:Amt>000000000000100</NS2:Amt>
              <NS2:CurCodeValue>ZAR</NS2:CurCodeValue>
            </NS2:TrnAmt>
            <NS2:TrnEffDt>2026-03-26</NS2:TrnEffDt>
            <NS2:BalAmt>
              <NS2:Amt>000000000500000</NS2:Amt>
            </NS2:BalAmt>
          </NS2:TrnData>
          <NS2:FIData>
