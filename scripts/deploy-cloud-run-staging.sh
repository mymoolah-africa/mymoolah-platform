...
deploy_service() {
  ...
  gcloud run deploy "${SERVICE_NAME}" \
    ...
    --set-env-vars "NODE_ENV=production,CLOUD_SQL_INSTANCE=${CLOUD_SQL_INSTANCE},CORS_ORIGINS=https://stagingwallet.mymoolah.africa,DB_SSL=false,DB_HOST=/cloudsql/${CLOUD_SQL_INSTANCE},DB_NAME=mymoolah_staging,DB_USER=mymoolah_app" \
