...
# This script only deploys and does not build/push the Docker image.
# The main deployment script (build-push-deploy-staging.sh) handles build, push, and deploy in one command.
