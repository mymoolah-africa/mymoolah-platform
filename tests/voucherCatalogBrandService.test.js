...
describe('voucherCatalogBrandService', () => {
  test.each([
    ...
    ['OTT R5', 'OTT Voucher', 'ott-voucher'],
    ['OTT Variable Voucher', 'OTT Voucher', 'ott-voucher'],
    ['Netflorist Voucher R100', 'NetFlorist', 'netflorist'],
    ['Easybet voucher', 'EasyBet', 'easybet'],
    ['Gbets Voucher R10-R4000', 'GBets', 'gbets'],
    ['Goldrush Voucher R10 - R4000', 'Gold Rush', 'gold-rush'],
